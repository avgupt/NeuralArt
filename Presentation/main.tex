...
\begin{frame}
    \frametitle{About us}
    \begin{tabular}{cc}
        \includegraphics[height=0.55\textheight]{avishi.jpg}
        &
        \includegraphics[height=0.55\textheight]{sshivangi.jpg}
        &
        \includegraphics[height=0.55\textheight]{vnaaz.jpg}
        Avishi Gupta&Shivangi Tomar&Vaseem Naazleen
    \end{tabulary}
\end{frame}
