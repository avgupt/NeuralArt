...
\begin{frame}
		\frametitle{Overview}
		Our project aims to recast the content of one image in the style of another image by implenting a neural algorithm by Leon A.Gatys, Alexander S. Ecker and Matthias Bethge.
...
\begin{frame}
		...
		\item Making presentation using Beamer
...
\begin{frame}
		...
		\setbeamertemplate{itemize items}[ball]
        \begin{itemize}
				\item The program took lot of time to output stylized image.
		\end{itemize}
\end{frame}
